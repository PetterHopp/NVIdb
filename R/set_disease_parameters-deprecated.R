...
#' @title set_disease_parameters is Deprecated
#' @description \code{set_disease_parameters} was deprecated in NVIdb v0.13.0 released
...
set_disease_parameters <- function(purpose = NULL,
  ...
  # DEPRECATED ----
  .Deprecated(new = "set_disease_parameters",
              package = "NVIdb",
              msg = paste("'set_disease_parameters' is replaced by
                          'NVIpjsr::set_disease_parameters'"))

  if (isTRUE(NVIcheckmate::check_package(x = "NVIpjsr", type = "installed"))) {
    select_statement <- NVIpjsr::set_disease_parameters(purpose = purpose,
