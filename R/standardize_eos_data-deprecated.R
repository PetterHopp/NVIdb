...
#' @name standardize_eos_data-deprecated
#' @keywords internal
#'
#' @examples
#' \dontrun{
...
#' @title standardize_eos_data is Deprecated
#' @description \code{standardize_eos_data} was deprecated in NVIdb v0.13.0 released
...
standardize_eos_data <- function(data,
  ...
  .Deprecated(new = "standardize_eos_data",
              package = "NVIdb",
              msg = paste("'standardize_eos_data' is replaced by
                          'NVIpjsr::standardize_eos_data'"))
