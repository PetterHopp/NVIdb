...
#' @name add_PJS_code_description-deprecated
#' @keywords internal
#' @examples
#' \dontrun{
...
#'     \code{copy_PJS_code_2_text} were deprecated in NVIdb v0.13.0 released
...
#'     and \code{NVIpjsr::copy_PJS_code_2_text} instead. When attaching packages,
