...
#' @md
#' @name select_PJSdata_for_value-deprecated
#' @keywords internal
#'
NULL

#' @title select_PJSdata_for_value is Deprecated
#' @description \code{select_PJSdata_for_value} was deprecated in NVIdb v0.13.0 released
...
select_PJSdata_for_value <- function(data,
  ...
  # DEPRECATED ----
  .Deprecated(new = "select_PJSdata_for_value",
              package = "NVIdb",
              msg = paste("'select_PJSdata_for_value' is replaced by
                          'NVIpjsr::select_PJSdata_for_value'"))

  if (isTRUE(NVIcheckmate::check_package(x = "NVIpjsr", type = "installed"))) {
    select_statement <- NVIpjsr::select_PJSdata_for_value(data = data,
                                                          code_column = code_column,
                                                          value_2_check = value_2_check,
