...
#' @name build_query_one_disease-deprecated
#' @keywords internal
#'
#' @examples
...
#' @title build_query_one_disease is Deprecated
#' @description \code{build_query_one_disease} was deprecated in NVIdb v0.13.0 released
...
build_query_one_disease <- function(year, analytt, hensikt = NULL, metode = NULL, db = "PJS") {
  ...
  .Deprecated(new = "build_query_one_disease",
              ...
              msg = paste("'build_query_one_disease' is replaced by
                          'NVIpjsr::build_query_one_disease'"))

  if (isTRUE(NVIcheckmate::check_package(x = "NVIpjsr", type = "installed"))) {
    select_statement <- NVIpjsr::build_query_one_disease(year = year,
                                                         analytt = analytt,
                                                         hensikt = hensikt,
                                                         metode = metode,
                                                         db = db)
