...
The issue tracker is for both Bug Reports and Feature Requests. If you think you have found a bug, you can raise an issue by going to [`https://github.com/NorwegianVeterinaryInstitute/NVIdb/issues`](https://github.com/NorwegianVeterinaryInstitute/NVIdb/issues) and submit a reproducible example. 
