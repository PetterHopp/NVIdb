...
The function add_PJS_code_description can be used to translate PJS codes into descriptive text. When the column names have been standardised, you must input the column names and the function translate to standard names for the columns with the text. See help for add_PJS_code_description how to do it with non-standard names. 

The code below is dependent on the translation table already have been imported in a previous step.
```{r, include = TRUE}
