...
We retrieve data from PJS though view in the data base journalrapp. Here are views for different purposes. If we need all data for a disease, we usually use the view v1_sak_med_res_eier that combines all information from sak to result level and that includes konklusjon and eier_lokalitet. 
...
- all saker with rabies-specific hensikt, i.e. they shall or should have been examined for rabies
- all saker med metode specific for rabies, i.e. samples have been set up with a rabies examination
